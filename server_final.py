...
def handle_client(server_socket,receipt,receipt1,i):
    ...
    while True:
        ...
        if(client_address[1]  in lst):
            ...
            if message == "1":
                ...
                modified_message2 = pickle.dumps(receipt1)
...
thread = threading.Thread(target=handle_client, args=(server_socket_udp,receipt,receipt1,i))
thread.start() 
#starts the execution of the function in a seprate thread